...
<body>
	<%
		...
		// 지역변수인 경우 가져다가 못 쓰니까 외부에서 초기화 시켜주기
		String savedId = ""; 
		String savedPw = ""; // 비밀번호 추가
	...
	<form action="loginOk.jsp" method="post">
		...
		비밀번호 <input type="password" name="loginPw" value="<%= savedPw %>"><br/>
		<!-- 체크박스가 체크된 채로 아이디 저장을 하게 되면 로그아웃을 하게 되어도 체크박스의 체크가 계속 남아 있게 -->
		<input type="checkbox" name="rememberId" <%= (savedId.isEmpty() ? "" : "checked") %>> 자동 로그인<br/>
